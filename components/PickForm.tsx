  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        >
          <div>
            <span className="font-bold text-black">Rules & Details</span>
            <span className="text-sm text-gray-500 ml-3">Pick 6 · $50,000 cap · Lowest score wins</span>
          </div>
          <span className="text-gray-400 text-lg">{rulesOpen ? "▲" : "▼"}</span>
        </button>
